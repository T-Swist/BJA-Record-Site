...
const membershipTiers = [
  {
    ...
    period: 'month',
    features: [
      'Access to recording studio basics',
  ...
  },
  {
    ...
    period: 'month',
    features: [
      'All Emerging Artist benefits',
      'Priority studio time booking',
  ...
  },
  {
    ...
    period: 'month',
    features: [
      'All Professional Artist benefits',
      'Unlimited studio access',
      'Full production & mastering',
      'Global distribution priority',
      'Personal A&R representation',
      'Tour & event management support'
    ],
  ...
  return (
    <div className="min-h-screen bg-gradient-ash pt-24">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-5xl font-display text-bronze mb-4">Artist Membership</h1>
          <p className="text-white/80 font-sans max-w-2xl mx-auto">
            Join our artist development programs and take your music career to the next level
          </p>
        </motion.div>
          ...
          {membershipTiers.map((tier, index) => (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full px-6 py-3 bg-auburn text-black rounded-full font-sans hover:bg-bronze hover:text-white transition-colors"
              >
                Select {tier.name}
              </motion.button>
            </motion.div>
        ...
        >
          <h2 className="text-2xl font-display text-bronze-light mb-4">Ready to Start Your Journey?</h2>
          <p className="text-white/60 font-sans mb-6">
            Our A&R team is here to help you choose the perfect membership tier
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
