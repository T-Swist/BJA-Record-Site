...
const products = [
  {
    id: 1,
    name: 'BJA Record Empire Classic Tee',
    price: 29.99,
            ...
            >
              ...
              <div className="p-6">
                ...
                <motion.button
                  ...
                  className="w-full px-6 py-2 bg-auburn text-black rounded-full font-sans hover:bg-bronze hover:text-white transition-colors"
                >
                  Add to Cart
                </motion.button>
              </div>
